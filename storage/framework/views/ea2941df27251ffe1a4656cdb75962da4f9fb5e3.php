	...
	<div class="row follow-links pagelike-links">
		...
		?>
			...
			<!--<?php if($user->price >= 0): ?>-->
				...
				<!--<?php if(Auth::check() || !$user->followers->contains($user->id)): ?>-->

						<div class="col-md-6 col-sm-6 col-xs-6 left-col">
							<a href="<?php echo e(url('/login')); ?>" class="btn btn-options btn-block btn-default follow" data-price="<?php echo e($user->price); ?>"  data-timeline-id="<?php echo e($timeline->id); ?>">
				...
				<!--<?php else: ?>-->
					...
					<div class="col-md-6 col-sm-6 col-xs-6 hidden">
						<a href="#" class="btn btn-options btn-block btn-default follow " data-price="<?php echo e($user->price); ?>" data-timeline-id="<?php echo e($timeline->id); ?>">
							<i class="fa fa-heart"></i> <?php echo e(trans('common.follow')); ?>
...
<div class="user-bio-block">
	...
	<a target="_blank" href="<?php echo e($user->instagram); ?>"><?php echo e($user->instagram); ?></a><br>
