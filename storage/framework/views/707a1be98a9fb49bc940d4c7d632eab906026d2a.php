	...
	<div class="timeline-cover">
		...
		<ul class="list-inline pagelike-links">							
			...
			<?php if(!$user->timeline->albums->isEmpty()): ?>
				<li class=""><a href="" > <?php echo e(trans('common.photos')); ?></span></a></li>
			<?php endif; ?>
			<li class="timeline-cover-status <?php echo e(Request::segment(2) == 'followers' ? 'active' : ''); ?>">
				<a href="" ><span class="top-list"><?php echo e($followers_count); ?>  <?php echo e(trans('common.followers')); ?></span>
				</a>
			</li>
			<li class="timeline-cover-status <?php echo e(Request::segment(2) == 'followers' ? 'active' : ''); ?>">
			...
			<li class="timeline-cover-status <?php echo e(Request::segment(2) == 'followers' ? 'active' : ''); ?>">
				<a href="" ><span class="top-list"><?php echo e($following_count); ?>  <?php echo e(trans('common.following')); ?></span>
				</a>
			</li>

			<?php if($user->username != $timeline->username): ?>
				<?php if(!$timeline->reports->contains($user->id)): ?>
				<li class="pull-right">
		...
		<div class="user-timeline-name">
			<a href=""><?php echo e($timeline->name); ?></a><br><a class="user-timeline-username" href="<?php echo e(url($timeline->username)); ?>"><?php echo e($timeline->username); ?></a>
